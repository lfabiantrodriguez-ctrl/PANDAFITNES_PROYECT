...
CREATE TABLE reservas (
    ...
    estado ENUM('pendiente', 'confirmada', 'cancelada', 'cancelada_emergencia', 'no_show', 'finalizada') DEFAULT 'pendiente',
    tipo ENUM('normal', 'reintegro_emergencia') NOT NULL DEFAULT 'normal',
    reserva_origen_id INT NULL,
    duracion_minutos INT NULL,
    cancelada_emergencia TINYINT(1) NOT NULL DEFAULT 0,
    creado_en TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (usuario_id) REFERENCES usuarios(id),
